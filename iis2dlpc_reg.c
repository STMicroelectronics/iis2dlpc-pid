...
{
  iis2dlpc_ctrl1_t ctrl1 = {0};
  iis2dlpc_ctrl3_t ctrl3 = {0};
  int32_t ret = {0};
...
int32_t iis2dlpc_filter_path_set(const stmdev_ctx_t *ctx,
                                 iis2dlpc_fds_t val)
{
  iis2dlpc_ctrl6_t ctrl6 = {0};
  iis2dlpc_ctrl7_t ctrl_reg7 = {0};
  int32_t ret = {0};
                                    ...
                                    iis2dlpc_ctrl4_int1_pad_ctrl_t *val)
{
  ...
  iis2dlpc_ctrl5_int2_pad_ctrl_t ctrl5_int2_pad_ctrl = {0};
  iis2dlpc_ctrl7_t reg = {0};
  int32_t ret = {0};
...
{
  iis2dlpc_ctrl7_t ctrl_reg7 = {0};
  iis2dlpc_ctrl4_int1_pad_ctrl_t  ctrl4_int1_pad = {0};
  int32_t ret = {0};
...
{
  iis2dlpc_wake_up_ths_t wake_up_ths = {0};
  iis2dlpc_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
...
{
  iis2dlpc_wake_up_dur_t wake_up_dur = {0};
  iis2dlpc_free_fall_t free_fall = {0};
  int32_t ret = {0};
